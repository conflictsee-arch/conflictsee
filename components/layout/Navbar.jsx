    ...
    <>
      ...
      <div className="conflict-banner" style={{
        ...
        <span style={{
          ...
          <AlertTriangle size={13} strokeWidth={2.5} style={{ flexShrink: 0 }} /> CONFLICT ACTIVE — DAY {dayCount} &nbsp;|&nbsp; Iran-Israel War &nbsp;|&nbsp; ConflictSee &nbsp;|&nbsp;
          Last Updated: <span style={{ fontFamily: 'var(--font-space-mono), Space Mono, monospace' }}>{mounted ? time : '--:--:--'}</span> IST &nbsp;|&nbsp; <RefreshCw size={12} strokeWidth={2.5} style={{ verticalAlign: '-2px' }} /> Auto-refresh: ON
        </span>
      </div>
