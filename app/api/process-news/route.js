...
If not war-related: {"skip":true}`,
  ...
  rumors: `You are an intelligence analyst for ConflictSee covering the Iran-Israel-US war (Feb 28 2026).
Extract from this article and return ONLY valid JSON:
{
  "title": "concise headline under 80 chars",
  "summary": "1 sentence with the key claim",
  "detail": "3-4 sentences of full context on the claim, who made it, and why it is unverified",
